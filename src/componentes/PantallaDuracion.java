...
public class PantallaDuracion extends javax.swing.JPanel {
        public PantallaDuracion() {
        setLayout(new BorderLayout());
        setBackground(Color.WHITE);
        
       // Título superior del panel (NO se mueve con el scroll)
       JLabel titulo = new JLabel("Base de datos de partidas por duracion", SwingConstants.CENTER);
       ...
       add(titulo, BorderLayout.NORTH); // título como encabezado del panel
        ...
        List<Partida> partidas = ConexionBD.obtenerPartidasOrdenadasPorDuracion();
