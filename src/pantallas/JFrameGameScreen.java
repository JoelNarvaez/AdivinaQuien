...
public class JFrameGameScreen extends javax.swing.JFrame {
   ...
   // Crear perfil button
    ...
    public static void main(String[] args) {
        String nickname="Tania";
        int edad =18;
        String profileIcon="ariel.png";
        Jugador jugador = new Jugador(nickname, profileIcon, 18); // aquí defines tu jugador

        SwingUtilities.invokeLater(() -> {
            new JFrameGameScreen(jugador); // y lo pasas al constructor
        });
    }
