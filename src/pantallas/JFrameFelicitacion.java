...
public class JFrameFelicitacion extends javax.swing.JFrame {
    ...
    public JFrameFelicitacion(String jugadorGanador) {
     ...
     private void ajustarComponentes(String jugadorGanador) {
        ...
        jLabelMusicaGanaste.setBounds((int)(0.9270 * anchoPantalla),  (int)(0.0648 * altoPantalla), (int)(0.0348 * anchoPantalla),(int)(0.0925 * altoPantalla));
        ...
        ImageIcon imgMusica = new ImageIcon(getClass().getResource("/Imagenes/disenoPantallas/musicaGanaste.png"));
        Image imgMusicaRedimensionada = imgMusica.getImage().getScaledInstance(jLabelMusicaGanaste.getWidth(), jLabelMusicaGanaste.getHeight(), Image.SCALE_SMOOTH);
        jLabelMusicaGanaste.setIcon(new ImageIcon(imgMusicaRedimensionada));
     }
    ...
    private void initComponents() {
        ...
        jLabelMusicaGanaste = new javax.swing.JLabel();
        ...
        jLabelMusicaGanaste.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/disenoPantallas/musicaGanaste.png"))); // NOI18N
        jLabelMusicaGanaste.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabelMusicaGanasteMouseClicked(evt);
            }
        });
        jPanelPrincipal.add(jLabelMusicaGanaste);
        jLabelMusicaGanaste.setBounds(1780, 110, 67, 100);
    ...
    private void jLabelMusicaGanasteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelMusicaGanasteMouseClicked
        // TODO add your handling code here:
        reproductor.alternarMusica();
    }//GEN-LAST:event_jLabelMusicaGanasteMouseClicked
    ...
    private javax.swing.JLabel jLabelMusicaGanaste;
